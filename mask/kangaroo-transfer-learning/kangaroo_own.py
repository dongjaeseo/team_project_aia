...
train_dataset.load_dataset(dataset_dir='C:/tp/Mask-RCNN-TF2/kangaroo-transfer-learning/kangaroo', is_train=True)
train_dataset.prepare()

# Validation
validation_dataset = LaneDataset()
validation_dataset.load_dataset(dataset_dir='C:/tp/Mask-RCNN-TF2/kangaroo-transfer-learning/kangaroo', is_train=False)
